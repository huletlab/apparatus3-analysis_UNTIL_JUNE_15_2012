...
//Modified by Pedro 
#define set_b( b ) ((b) ? "\33[1m" : "")
#define set_i( i ) ((i) ? "\33[3m" : "")
#define set_u( u ) ((u) ? "\33[4m" : "")
#define set_r( r ) ((r) ? "\33[7m" : "")
...
//Modified by Pedro to avoid setting colors
#define set_attributes( b, i, u, r ) set_b( b ) << set_i( i ) << set_u( u ) << set_r( r ) 
...
/*
 ----------------------------------------------
 Terminal macros to use with printf() 
 ----------------------------------------------
*/
#define RESET   "\033[0m"
